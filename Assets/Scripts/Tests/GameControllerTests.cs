...
namespace Tests
{
    ...
    public class GameControllerTests
    {
        ...
        public void CanMoveUnit_SwordsmanOnGrass_True()
        {
            ...
            var grass = new Grass();
            grass.Position.Set(grassPositionX, grassPositionY);
        ...
        public void CanMoveUnit_SwordsmanOnWater_False()
        {
            ...
            swordsman.Position.Set(10, 10);
            var water = new Water();
            swordsman.Position.Set(waterPositionX, waterPositionY);
        ...
        public void CanMoveUnit_CatapultOnHorseman_False()
        {
            ...
            var horseman = new Horseman(player);
            horseman.Position.Set(horsemanPositionX, horsemanPositionY);
        ...
        public void MoveUnit_AllTypes()
        {
            ...
            var archer = new Archer(player);
            archer.Position.Set(14, 14);
            gameController.MoveUnit(archer, movePositionX, movePositionY);
            Assert.AreEqual(movePositionX, archer.Position.X);
            Assert.AreEqual(movePositionY, archer.Position.Y);

            var catapult = new Catapult(player);
            catapult.Position.Set(14, 14);
            gameController.MoveUnit(catapult, movePositionX, movePositionY);
            Assert.AreEqual(movePositionX, catapult.Position.X);
            Assert.AreEqual(movePositionY, catapult.Position.Y);

            var horseman = new Horseman(player);
            horseman.Position.Set(14, 14);
            gameController.MoveUnit(horseman, movePositionX, movePositionY);
            Assert.AreEqual(movePositionX, horseman.Position.X);
            Assert.AreEqual(movePositionY, horseman.Position.Y);

            var swordsman = new Swordsman(player);
            swordsman.Position.Set(14, 14);
            gameController.MoveUnit(swordsman, movePositionX, movePositionY);
            Assert.AreEqual(movePositionX, swordsman.Position.X);
            Assert.AreEqual(movePositionY, swordsman.Position.Y);
        }
        ...
        public void AttackUnit_ArcherAttackAllTypes()
        {
            ...
            archerTarget.Position.Set(10, 10);
            ...
            catapultTarget.Position.Set(10, 10);
            ...
            horsemanTarget.Position.Set(10, 10);
            ...
            swordsmanTarget.Position.Set(10, 10);
        ...
        private static Map CreateMap(IReadOnlyList<Surface> ground = null, IReadOnlyList<Unit> units = null)
        {
            return new Map(ground ?? new Surface[0], units ?? new Unit[0]);
        }
    }
}