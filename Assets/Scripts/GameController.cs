...
public class GameController
{
    ...
    private readonly Sprite _archerSource = BuildSourceFromPath("Resources/Units/Archer.png");
    private readonly Sprite _catapultSource = BuildSourceFromPath("Resources/Units/Catapult.png");
    private readonly Sprite _horsemanSource = BuildSourceFromPath("Resources/Units/Horseman.png");
    private readonly Sprite _swordsmanSource = BuildSourceFromPath("Resources/Units/Swordsman.png");
    private readonly Sprite _deadUnitSource = BuildSourceFromPath("Resources/Units/Dead.png");
    private readonly Sprite _grassSource = BuildSourceFromPath("Resources/Ground/Grass.png");
    private readonly Sprite _waterSource = BuildSourceFromPath("Resources/Ground/Water.png");
    ...
    /// </summary>
    public Sprite GetObjectSource(object o)
    {
        if (o is Archer)
        {
            if (IsDead(o))
    ...
    /// </summary>
    private static Sprite BuildSourceFromPath(string path)
    {
        return null;
    }
}